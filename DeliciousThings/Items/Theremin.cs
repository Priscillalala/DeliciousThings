...
public partial class Theremin : ItemDef, Delicious.IStaticContent
{
    ...
    public readonly float attackSpeedBonus = Config.Bind(SECTION, "Attack Speed Bonus", 0.45f).Value;
    public readonly float attackSpeedBonusPerStack = Config.Bind(SECTION, "Attack Speed Bonus Per Stack", 0.35f).Value;
